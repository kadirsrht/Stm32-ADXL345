...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  gValueX = ADXL345_getGValue(X, SCALE_FACTOR_4G);
	  gValueY = ADXL345_getGValue(Y, SCALE_FACTOR_4G);
	  gValueZ = ADXL345_getGValue(Z, SCALE_FACTOR_4G);
